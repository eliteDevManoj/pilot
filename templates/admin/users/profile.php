  ...
  <?php include 'templates/admin/layouts/sidebar.php'; ?>
   ...
   <div class="wrapper flex grow flex-col">
    ...
    <?php include 'templates/admin/layouts/sub-navbar.php'; ?>
      ...
      <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
       <div class="flex flex-col justify-center gap-2">
        ...
        <div class="flex items-center gap-2 text-sm font-medium text-gray-600">
         Edit form below to update profile.
        </div>
       </div>
     ...
     <form method="post" action="/admin/users/profile" enctype="multipart/form-data">
      
      <input type="hidden" name="id" value="<?= $getUser['id'];?>">
      <input type="hidden" name="_method" value="PUT">

      <input type="hidden" name="oldProfilePic" value="<?php if(isset($getUser['profile']['photo'])){ echo $getUser['profile']['photo']; } ?>">
